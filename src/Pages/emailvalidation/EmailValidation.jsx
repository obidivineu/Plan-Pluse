            ...
            <main className='mainmail'>
                ...
                <section className='emailtext'>
                    <header className='wrapcontain'>
                        ...
                        <div className='emailmsg'><p>We have sent an email to <span style={{ color: "#FF595E",  cursor: "pointer"}}>ifitness123@gmai.com</span> to confirm
                            the validity of our email address. After receiving the email
                            follow the link provided to complete registration
                        </p>
                        </div>
                    </header>
                   
                    <p className='resend'>If you did not get any mail, <span style={{ color: "#111E3F", cursor: 'pointer'}}>Resend confirmation mail</span></p>
                </section>
            </main>
        </>
    )
